...
train_data_set = common.train_data_set
have_tomek = True
while have_tomek:
    count_before = len(train_data_set)
    train_data_set = tomek(common.train_data_set)
...
for index in range(len(common.check_data_set)):
    ...
    for k_i in range(0, k):
        category_map[sorted_array[k_i][common.attribute_count]] = category_map[sorted_array[k_i][common.attribute_count]] + 1
